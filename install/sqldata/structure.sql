...
--
-- Structure for table "ecs_aftermarket_attachments"
--
...
--
-- Structure for table "ecs_order_return"
--
...
CREATE TABLE IF NOT EXISTS `ecs_order_return` (
  ...
  PRIMARY KEY (`ret_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品退货表' AUTO_INCREMENT=1 ;
...
--
-- Structure for table "ecs_return_action"
--
...
--
-- Structure for table "ecs_return_cause"
--
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='退换货原因说明';

--
-- Structure for table "ecs_return_goods"
--
...
--
-- Structure for table "ecs_service_type"
--
