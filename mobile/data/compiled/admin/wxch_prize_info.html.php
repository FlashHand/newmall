...
?>
                ...
                <tr>
                    <td class="label"><?php echo $this->_var['item']['level']; ?>：</td>
                    <td >
                        <label>&nbsp;&nbsp;<input type="text" name="prize_name[]" value="<?php echo $this->_var['item']['prize_name']; ?>" size="15"/></label>
                    </td>
                    <td >
                        <label>&nbsp;&nbsp;<input type="text" name="prize_value[]" value="<?php echo $this->_var['item']['prize_value']; ?>" size="5"/></label>
                        <input type="hidden" name="prize_id[]" value="<?php echo $this->_var['item']['id']; ?>"/>
                    </td>
                    <td>
                        <?php echo $this->_var['item']['rand']; ?>‰
                    </td>
                </tr>
