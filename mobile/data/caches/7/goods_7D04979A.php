<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:61:"D:/phpStudy/WWW/shenxian/mobile/themes/ocailong_com/goods.dwt";i:1;s:72:"D:/phpStudy/WWW/shenxian/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:75:"D:/phpStudy/WWW/shenxian/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1470202613;s:8:"maketime";i:1470199013;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>爱食派内蒙古呼伦贝尔冷冻生鲜牛腱子肉1000g_根茎类_生鲜食品_ 触屏版</title>
...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '9998件';
    }else{
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/9_thumb_G_1448944791708.jpg"  alt="爱食派内蒙古呼伦贝尔冷冻生鲜牛腱子肉1000g" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://sx.noonet.cn/images/201512/goods_img/9_P_1448944791077.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://sx.noonet.cn/images/201512/goods_img/9_P_1448944791129.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://sx.noonet.cn/images/201512/goods_img/9_P_1448944791617.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://sx.noonet.cn/images/201512/goods_img/9_P_1448944791229.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  ...
  <div class="title">
    <h1> 爱食派内蒙古呼伦贝尔冷冻生鲜牛腱子肉1000g </h1>
  </div>
    <div class="title">
     
  </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>168</span></b>　    <del>￥<span>202</span></del> 
    </li>
     
	    <li>	
	注册用户：<b class="price" >￥<span>134</span></b></li>
  </ul>
      <ul>
    <li>
...
var myString=new Array();
	   ...
	   <span class="ui-number radius5" style="float:left;"> 
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9998" type="text" />
	 ...
	 <!--
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://sx.noonet.cn/images/201512/source_img/9_G_1448944791630.jpg"> </div>
            <div id="right">
              <p>爱食派内蒙古呼伦贝尔冷冻生鲜牛腱子肉1000g</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		...
	  		<p><img width="790" height="441" src="http://sx.noonet.cn/images/upload/Image/1(1).jpg" alt="" /><br />
<img width="790" height="595" src="http://sx.noonet.cn/images/upload/Image/2.jpg" alt="" /><br />
<img width="790" height="602" src="http://sx.noonet.cn/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:9;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1470199013,
    nonceStr: '1romhrToJqHIzeG6',
    signature: '8ab06cb9c77aed93ce685ac33989052759f520d1',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '爱食派内蒙古呼伦贝尔冷冻生鲜牛腱子肉1000g',
      link: 'http://sx.noonet.cn/mobile/index.php?u=168',
      imgUrl: 'http://sx.noonet.cn/images/201512/source_img/9_G_1448944791630.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(9)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(9);">加入购物车</button>
