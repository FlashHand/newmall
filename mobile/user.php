...
'account_deposit', 'account_log', 'account_detail', 'act_account', 'pay', 'default', 'bonus', 'group_buy', 'group_buy_detail', 'affiliate', 'comment_list','validate_email','track_packages', 'transform_points','qpassword_name','mpassword_name','send_pwd_mobile', 'get_passwd_question', 'check_answer','point','user_card','fenxiao1','myorder','myorder_detail','fenxiao2','fenxiao3','fenxiao4','bindmobile', 'back_order', 'back_list', 'back_order_detail', 'back_order_act', 'back_replay', 'del_back_order', 'back_order_detail_edit');
...

{
	...
	/*模板之家(www.mb5.com.cn)新增显示分销会员标准*/
...

{
	...
	show_message($_LANG['edit_profile_success'], $_LANG['profile_lnk'], 'distribute.php', 'info');
...

{
    ...
    include_once(ROOT_PATH . 'include/lib_transaction.php');
	include_once (ROOT_PATH . 'include/lib_transaction_1.php');
...

{
    ...
    if($_GET['flag'] == 'display'){
        ...
        $province_list = get_regions(1, $_CFG['shop_country']);
...

{
...

    {
		...
		//开始开发，兼容微信支付-模板之家-www.mb5.com.cn
...

{
	...
	//模1板2之3家-www.mb5.com.cn显示会员等级和下面人数
