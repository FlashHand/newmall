...
?>
	...
	?>
	<?php $_from = $this->_var['adlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_82072500_1470199821');$this->_foreach['ad'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ad']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_82072500_1470199821']):
        $this->_foreach['ad']['iteration']++;
?>  
	   <?php echo $this->_var['ad_0_82072500_1470199821']['content']; ?>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </div>
    <div class="pro_list">
      <ul class="cle">
		<?php $_from = $this->_var['cat_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_82093300_1470199821');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_82093300_1470199821']):
?>
        <li> <a href="<?php echo $this->_var['goods_0_82093300_1470199821']['url']; ?>" target="_blank">
          <p class="pic"> <img src="<?php echo $this->_var['goods_0_82093300_1470199821']['thumb']; ?>" style="display: inline;"></p>
          <h3><?php echo htmlspecialchars($this->_var['goods_0_82093300_1470199821']['short_name']); ?></h3>
          <p class="price">  
          <?php if ($this->_var['goods_0_82093300_1470199821']['promote_price'] != ""): ?>
          <?php echo $this->_var['goods_0_82093300_1470199821']['promote_price']; ?>
          <?php else: ?>
          <?php echo $this->_var['goods_0_82093300_1470199821']['shop_price']; ?>
          <?php endif; ?></p>
          </a> </li>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </ul>
