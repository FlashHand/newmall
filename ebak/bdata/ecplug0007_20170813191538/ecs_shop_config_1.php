...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ECTouch微商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ECTouch微商城','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ECTouch微商城','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ECTouch微商城','1');");
...
E_D("replace into `ecs_shop_config` values('203','2','icp_file','file','','../data/certificate/','','1');");
E_D("replace into `ecs_shop_config` values('204','2','watermark','file','','../data/attached/images/','','1');");
...
E_D("replace into `ecs_shop_config` values('215','2','no_picture','file','','../data/attached/images/','','1');");
...
E_D("replace into `ecs_shop_config` values('241','2','certi','hidden','','','http://service.ectouch.cn/openapi/api.php','1');");
...
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1502622367','1');");
...
E_D("replace into `ecs_shop_config` values('902','9','wap_logo','file','','../data/attached/images/','','1');");
