...
E_D("replace into `ecs_wechat_menu` values('4','1','1','商城首页','view','','http://localhost','1','1');");
...
E_D("replace into `ecs_wechat_menu` values('11','1','3','会员中心','view','','http://localhost/?c=user','1','1');");
