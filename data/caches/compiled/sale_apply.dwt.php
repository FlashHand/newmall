...
<div class="fx-fdong">
    <div class="fx-fdong-con">
        <img class="fx-fdong-con-img" src="<?php if ($this->_var['headimgurl']): ?><?php echo $this->_var['$headimgurl']; ?><?php else: ?>__TPL__/sale/images/fenxiao-img.png<?php endif; ?>" />
        <span class="fx-fdong-price" id="price">¥<?php echo $this->_var['money']; ?></span>
...
<div id="pay-money-zf" style="display:none;"><?php echo $this->_var['pay_online']; ?></div>
