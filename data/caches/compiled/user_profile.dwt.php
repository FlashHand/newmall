	...
	<section class="flow-consignee ect-bg-colorf s-user-top onclik-admin">
		<ul>
			<li class="dis-box s-xian-box s-user-top-1">
				...
				<div class="box-flex t-goods1  onelist-hidden"> <input name="email" type="text" readonly="readonly" placeholder="<?php echo $this->_var['info']['username']; ?>" value="<?php echo $this->_var['info']['username']; ?>" style="padding-right:10px;margin-right:10px;width:250px"></div>
			</li>
			<li class="dis-box s-xian-box s-user-top-1">
				<h3 class="profile-left-name text-all-span my-u-title-size"><?php echo $this->_var['lang']['email']; ?>：</h3>
				<div class="box-flex t-goods1 onelist-hidden "> <input name="email" type="text" placeholder="<?php echo $this->_var['lang']['no_emaill']; ?>" value="<?php echo $this->_var['profile']['email']; ?>" style="padding-right:10px;margin-right:10px;width:250px"></div>
			</li>
...
?>
			...
			<li class="dis-box s-xian-box s-user-top-1">
				...
				<div class="box-flex t-goods1  onelist-hidden"> <input name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" value="<?php echo $this->_var['field']['content']; ?>" placeholder="<?php echo $this->_var['field']['reg_field_name']; ?>" style="padding-right:10px;margin-right:10px;width:250px"></div>
			</li>
			<?php endif; ?>
