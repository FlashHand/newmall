...
<div id="box">
	...
	<section class="padding-all">
		<div class="padding-all huang-bg n-ti-bg open-two-box b-r">
			<h4 class="n-set3_list2">注册成功！请保存以下信息：<i class="iconfont icon-huangse icon-hao f-r" onClick="close_class('set2_content')"></i></h4>
			<p class="f-03 n-set_list"><span>微店地址：<br><?php echo $this->_var['sale_url']; ?></span></p>
		</div>

		<div class="n-con-sale">
			<h4 class="f-07 col-4 m-t05">新手必读</h4>
			<p class="col-6 f-03 m-t "><?php echo $this->_var['novice']; ?></p>
		</div>

		<div class="n-but-box n-lv-bg  b-r">
			<a href="<?php echo url('store/index', array('drp_id'=>$this->_var['drp_id']));?>"><span class="text-c color-whie f-08">进入我的微店</span></a>
		</div>
	</section>
	</body>
