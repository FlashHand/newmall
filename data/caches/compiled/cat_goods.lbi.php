...
?> 
    ...
    <?php endif; ?>
      <a href="<?php echo $this->_var['cat_goods']['url']; ?>"><img src="<?php echo $this->_var['cat_goods']['goods_thumb']; ?>" alt="<?php echo $this->_var['cat_goods']['goods_name']; ?>" /></a>
      <a href="<?php echo $this->_var['cat_goods']['url']; ?>"><p><?php echo $this->_var['cat_goods']['goods_name']; ?></p></a>
